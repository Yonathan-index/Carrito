...
courseBtn.forEach(btn =>{
    btn.addEventListener('click', e => {
       ...
       if(exist){
        console.log(exist.children[3].innerHTML);
        ...
        exist.children[3].innerHTML = Number(exist.children[3].innerHTML) + 1;
            ...
            row.innerHTML = `
                ...
                <td>15$</td>
                <td>1</td>
                <td><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class ="delete-btn">
